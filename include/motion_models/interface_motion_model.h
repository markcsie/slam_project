...
{
public:
  virtual Eigen::MatrixXd calculateRt(const std::shared_ptr<const RobotModelInterface> &robot_model, const Eigen::VectorXd &x, const Eigen::VectorXd &u, const Eigen::MatrixXd &cov) const = 0;
